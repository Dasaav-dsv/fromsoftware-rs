...
pub struct RvaBundle {
    ...
    pub csin_game_key_assign_vmt: u32,
    pub csin_game_pad_vmt: u32,
    pub cskey_assign_vmt: u32,
    pub cslua_event_msg_exec_func_vmt: u32,
    pub cslua_event_msg_exec_string_vmt: u32,
    pub cslua_event_msg_exec_vmt: u32,
    pub csmenu_viewer_key_assign_vmt: u32,
    pub csmenu_viewer_pad_vmt: u32,
    ...
    pub dluser_input_device_impl_vmt: u32,
    pub dummy_device_vmt: u32,
    ...
    pub obtain_dl_user_input_manager: u32,
    pub open_field_chr_set_vmt: u32,
    pub pad_device_vmt: u32,
